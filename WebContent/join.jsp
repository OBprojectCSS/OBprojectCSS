...
<script>
	...
	function idCheck() {
		...
		window.open("controller?type=idCheck&id=" + account, "chkForm",
				"width=350, height=300, resizable=no, scrollbars=no");
	}
</script>
	...
	<div class="container">
		...
		<form id="join" method="POST" name="formm">
			<fieldset>
				...
				<label>아이디</label> <input type="text" id="account" name="id"
					placeholder="회원아이디" size="22" onkeydown="inputIdChk()"> <input
					type="hidden" name="reid" value="idUncheck"> <input
					type="button" value="중복확인" class="dup" onclick="idCheck()"><br>
				<br> <label>비밀번호</label> <input type="password" name="pwd"
					placeholder="비밀번호"><br>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"
					name="address" id="roadaddress" placeholder="예) 서울특별시"><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"
					name="detail" placeholder="예) 마포구 백범로..."><br>
				<br> <label>E-Mail</label> <input type="text" name="email"
					placeholder="이메일"><br>
				<br> <label>생년월일</label> <input type="text" name="birthday"
					placeholder="예) 90/01/01"><br>
				<br> <label>광고 수신 동의</label> <input type="radio"
					name="e_confirm" value="0" checked>동의함&nbsp;&nbsp;&nbsp; <input
					type="radio" name="e_confirm" value="1">동의안함 <br>
			</fieldset>
			<br> <br>
			<div>
