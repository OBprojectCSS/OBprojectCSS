          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMoreoption">
                ...
                <a class="dropdown-item" href="controller?type=moreQue">자주 묻는 질문</a>
                <a class="dropdown-item" href="controller?type=que&board_type=3">문의 사항</a>
                <a class="dropdown-item" href="controller?type=premium&board_type=4">프리미엄 후기</a>
                <a class="dropdown-item" href="controller?type=agree">약관 및 동의사항</a>
              </div>
            </li>
            <!--  -->
