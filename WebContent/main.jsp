      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="services.html">이벤트</a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMoreoption">
                <a class="dropdown-item" href="portfolio-1-col.html">공지 사항</a>
                <a class="dropdown-item" href="portfolio-2-col.html">자주 묻는 질문</a>
                <a class="dropdown-item" href="portfolio-3-col.html">문의 사항</a>
                <a class="dropdown-item" href="portfolio-4-col.html">프리미엄 후기</a>
                <a class="dropdown-item" href="portfolio-item.html">약관 및 동의사항</a>
              </div>
            </li>
            <!--  -->
            <c:if test="${empty sessionScope.uservo}">
          <li class="nav-item">
              <a class="nav-link" href="controller?type=login" >로그인</a>
            </li>   
            </c:if>
